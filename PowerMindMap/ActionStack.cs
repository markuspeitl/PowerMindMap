...
{
    public class ActionStack : ActionStackInterface
    {
        ...
        public void RedoLast()
        {
            ...
            {
                MindNodeAction action = redoactions.Last();
                ...
                switch (action.name)
                {
                    case "CreateNode":
                        ...
                        {
                            MindNode createdNode = action.involvedNodes.Pop();
                            undoactions.Add(new MindNodeAction(1, "DeleteNode", createdNode));
                            createdNode.DeleteNode();
                        }
                        break;
                    case "DeleteNode":
                        ...
                        {
                            MindNode deletednode = action.involvedNodes.Pop();
                            undoactions.Add(new MindNodeAction(0, "CreateNode", deletednode));
                            deletednode.parent.AddChildNoStyle(deletednode,false);
                            // Refresh Pivot Representation after reinstating node
                            deletednode.UpdatePivots();
                        }
